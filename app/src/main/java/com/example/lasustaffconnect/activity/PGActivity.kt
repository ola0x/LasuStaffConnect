...
import com.example.lasustaffconnect.fragment.policy.PGNonAcdemicFragment
...
class PGActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txt_title.text = resources.getString(R.string.txt_pg)
        ...
        adapter.addFragment(PGAcademicFragment(), "Academics")
