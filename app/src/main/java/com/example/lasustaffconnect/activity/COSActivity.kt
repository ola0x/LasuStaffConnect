...
class COSActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txt_title.text = resources.getString(R.string.txt_cos)
        ...
        adapter.addFragment(COSSeniorFragment(), "Senior Staff")
        adapter.addFragment(COSJuniorFragment(), "Junior Staff")
