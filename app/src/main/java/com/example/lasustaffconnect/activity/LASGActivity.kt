...
class LASGActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txt_title.text = resources.getString(R.string.txt_lasg)
        ...
        adapter.addFragment(LASGOverviewFragment(), "Overview")
        adapter.addFragment(LASGPolicyFragment(), "View Service Rule")
