...
import com.example.lasustaffconnect.UsefulLink
import com.example.lasustaffconnect.R
import com.example.lasustaffconnect.ReportAnIncidence
...
class InfoActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fp_dict.setOnClickListener {
            val intent = Intent(this@InfoActivity, UsefulLink::class.java)
            startActivity(intent);
        }
    }
}